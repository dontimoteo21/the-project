    ...
    <div>
      ...
      <div className='navbar-main'>
        <ul className="nav nav-pills nav-stacked">
          <li className="active"><a href="/home"><i className="fa fa-home house-symbol" aria-hidden="true"></i>  Executive</a></li>
          ...
          <li className="dropdown">
            ...
            <ul className="dropdown-menu charts-dropdown">
              <li id='first-charts-category'><a href="/finances">Finances</a></li>
